...
# 3088
# finalData.decode('ascii')


data = i2c.readfrom_mem(64,1,2)
data = ustruct.unpack("<i", i2c.readfrom_mem(64,3,2))[0]
data = data >> 2
data = data * 0.03125
